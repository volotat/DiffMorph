...
gen_outdir = st.output_folder
split_folder = os.path.join(gen_outdir, "run_resized")
...
for name_id, spec in specs.items():
    ...
    if spec["N"] >= split_n:
        ...
        src_name1 = os.path.join(split_folder, name_id + "_right_split_top.png")
        src_name2 = os.path.join(split_folder, name_id + "_right_split_bot.png")
        trg_name1 = os.path.join(split_folder, name_id + "_left_split_top.png")
        trg_name2 = os.path.join(split_folder, name_id + "_left_split_bot.png")
